...
ancestor (see [campaign-overview §5](../lore/campaign-overview.md)), so the sea
...
out here. As with the [Egypt table](egypt.md), the myth is kept **unsanitized
...
- **Pass / parley.** Sirens, the Umibōzu, Sedna, the Kun — these are answered
  ...
  their myth. Always the first option (see [DMing principle §3](../lore/campaign-overview.md#4-dming-principles)).
...
Spd swim 60 ft. Bite +10 (4d10+7 piercing). Constrict the hull (+10, DC 17; a caught boat is squeezed, **1d8 hull boxes/round**, until the coil is driven off). Capsize (surfaces beneath a boat, DC 16 or the boat heels hard, everyone DC 14 or overboard). A lesser child of **Jörmungandr**, the serpent that circles the world with its own tail in its mouth (see the Thor-fishing myth). Too large to kill from a small boat — the encounter is to break its grip and run. Where the great Dragon Turtle holds Jotunheim ([lonka-jotunheim](../lore/lonka-jotunheim.md)), these lesser coils wander the open sea.
...
[comet cycle](../lore/campaign-overview.md#b-transformation) glimpsed whole and
...
into the dragonborn island (see [taniyn-and-lonka](../lore/taniyn-and-lonka.md)) —
...
[campaign-overview §5](../lore/campaign-overview.md), [demons-and-the-hotspot](../lore/demons-and-the-hotspot.md)).
...
- **The Dragon Turtle** holds the water at **Jotunheim** ([lonka-jotunheim](../lore/lonka-jotunheim.md)).
...
- **Taniyn** — the dragonborn creation leviathan ([taniyn-and-lonka](../lore/taniyn-and-lonka.md)).
...
- [egypt](egypt.md) — the sister table; the 2d6 reaction and three-beat run.
</content>
