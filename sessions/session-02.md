...
Commission in hand, the party left Maalm on foot for the **Valley of the
Kings**, out through the oasis gardens and into the rain-shadowed desert
where the sandstone cliffs are honeycombed with the tombs of the Amseh
dynasty.
...
## On the road — the Set-beast (the forked-tail jackal)

While crossing the desert, the party hunted, and the **Egypt hunt table**
(`bestiary/egypt.md`) turned up roll **16 — the Sha (Set-Animal)**, the
unidentifiable **forked-tail beast of Set**: a magical jackal-thing, not a
mundane scavenger. Because the party keeps **Speak with Animals** up, the
roll played out as a *conversation* rather than a fight, exactly as that
table intends.

- The party **fed it rat meat** (the rat-meat prop carries over from
  Session 1 — and unlike everyone else they'll try to feed it, the
  Set-beast actually *took* it).
- In conversation, the beast **gave them information about the lions**
  waiting in the Valley — a warning about the cave lions that guard one of
  the tombs. The party went in forewarned.

> **Continuity note:** This was a legitimate hunt-table result, not an
> improvisation — the Sha (CR 6 Fiend, forked bite + lightning + Sandstorm
> Step) is statted in `bestiary/egypt.md`. Worth noting its **boon/curse**
> if the party ate any of it: eating its liver grants advantage on saves vs.
...
The party reached the Valley and **cleared Tomb I** — the first of the four
Amseh tombs. They worked through its puzzle chamber and inner burial
chamber and recovered what the tomb held (per Preem's commission, the
**name** written there).
