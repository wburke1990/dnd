...
- **The watch** — [Maalm Watchmen](../bestiary/maalm-watch.md), one stat block
  ...
  (Marcellus, or one of his) at level 3.

---

# THE MAP

- The party is on the **dock**, the watch closing around them for the arrest.
- **Cassia's boat is at the pier, ~40–60 ft. out** — loading, the rest of the
  Second Hand aboard or on the gangway. That gap is the whole fight: the party
  has to cross it, and the crew is firing across it.
- The **water** is on three sides — the pier edge, the gap to the boat, the
  harbor. A shoved watchman in chain shirt and shield loses a round climbing
...
# THE SURPRISE ROUND — THE VOLLEY FROM THE BOAT

The watch is fixed on the party and the arrest; they don't clock the crew at the
boat as a threat until it's too late. **The moment the irons come out and it
turns violent, the Second Hand opens fire — a full surprise round, all ranged,
because they're 40–60 ft. off and can't reach melee yet.**

- **The crew is surprised no one — they act; the first wave of guards does not.**
  Run one round of Second Hand actions against flat-footed guards, then roll
  initiative for everyone. The party is **not** surprised (it's their arrest);
...
- **Then it closes.** From round 1 on, Halvard and Cassia move to put themselves
  ...
  Corvin and the casters keep to the boat and the pier, firing and covering the
  retreat.

---

# THE FIGHT — WAVES, AND A REASON TO RUN

- **Waves.** As the party drops the first batch, **more guards arrive** from the
  streets — the watch holds the harbor and can keep feeding bodies in. The fight
...
|---|---|---|
| **First wave (on the dock)** | 5 watchmen | 6 watchmen |
| **Surprise round** | crew volley drops ~2–3 of them | crew volley drops ~2–3 of them |
| **Reinforcements** | +3 watchmen every **other** round | +3–4 watchmen **every** round |
| **Sergeant** | none | **1 Watch Sergeant** leads wave 2 (Marcellus, or one of his) |
| **Waves before the boat is the obvious out** | 2–3 | 3–4 |

- **Don't count to a total.** The reinforcements are unlimited on paper; the
  fight ends when the party **casts off,** not when a body count is cleared. The
  numbers above are just the pressure per round — enough that standing still
  loses ground, few enough that a fighting retreat to the boat wins.
- **If it's too soft,** add the Sergeant (or a second one) and use **Hold the
  Line** to surge a wave onto the party. **If it's too hard,** thin the
  reinforcement waves or have Cassia's **Tactician** hand the party extra moves
  toward the boat.
