...
- [`lore/campaign-overview.md`](campaign-overview.md) — land/food zero-sum theme, regions.
- [`lore/house-rules-and-world-mechanics.md`](house-rules-and-world-mechanics.md) — the
  Abyss = tunnel-network.
- [`lore/the-second-foundation.md`](the-second-foundation.md) — Preem / the council cabal.
