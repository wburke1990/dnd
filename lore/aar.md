...
> **DM reference.** [Aar](nila-atlas.md), the **[Company](the-company.md)** ore-port on
> the coast of **[Suartleheim Eet](the-fallen-gnome-kingdom.md)**. The [Haals](nila-atlas.md)
...
> [cold-run packet](../encounters/cold-run-taverns-to-thinkers.md) §4. It is also where the
...
[Aal](nila-atlas.md) is up the coast to the north — the old Mughal port, going quiet since
the Company took the trade here (below).

## The watch-stone — where the gnomes came ashore `[Will 8/16]`

Aar is the coast where the gnomes first came ashore. When they fled the poisoned surface of
[Kalikhat](lonka-jotunheim.md), the dragonborn seer [Musa](the-fallen-gnome-kingdom.md) led
them here by sea; they made landfall on this harbour and took the country from the
...
The Sacred Hunt at [Brauron](../encounters/the-peach-town.md) runs once a year, and it is
the only way into the game preserve. When it comes near, the crews converge — hunters and
pilgrims working up the coast toward Brauron — and many pass through Aar and drink on the
...
[Aal](nila-atlas.md) is the other landfall, up the coast due north of Aar. Where Aar is new,
...
- **The Company office, store, and magistrate.** Keeps the wharves, the scale-book on the
  outbound barges, and the law ([the Company §4](the-company.md)).
...
- **[The Mughal founding](the-mughal-founding.md)** — the two ports and the two canals, and
  the Aal half-orc quarter.
- **[The fallen gnome kingdoms](the-fallen-gnome-kingdom.md)** — Musa's landfall, the shore
  the gnomes first came ashore on.
- **[Brauron](../encounters/the-peach-town.md)** and
  **[the game preserve](../encounters/the-game-preserve.md)** — the Sacred Hunt the dock
  crews are converging on.
- **[The Company](the-company.md)** — owns the port, the trade, and the law.
- **[The cold-run packet](../encounters/cold-run-taverns-to-thinkers.md)** §4 — Aar as a
...
- `[OPEN]` What the Company ships out besides ore. The crates the
  [Second Foundation](the-second-foundation.md) holds back at
  [Copaa](copaa.md) never reach the outbound barges; what does leave Aar by sea, the Company
  keeps to itself.
- `[OPEN]` Names — the Company clerk, the magistrate, a dockside tavern.
