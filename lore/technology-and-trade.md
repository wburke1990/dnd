...
> catastrophe (the [Bleeding Star](amseh-dynasty.md)) was, among other things, a **Bronze-Age
...
- **The lashed hull (the dragonborn way — and the *best* ocean tech there is).** The
  ...
  **[Bedraageon's](maalm-founding.md)** legendary **one-of-a-kind** craft carried **thirteen** at
...
- `[settled]` **Star-metal artifacts.** Seed the world with **ancient star-metal swords and
  ...
  ([Kuru](kuru-and-the-phoenix.md)). `[loose]` geothermal/volcanic heat as a flavorful path
...
- **The wandering Dragonborn** — the lashed-pontoon traditionalists (§1), heirs of the fallen
  Lonka/Tyre maritime age and kin to the [wandering saints](wandering-dragonborn.md).
- **The massive halfling fleets** — [Sam's people](floating-fleet.md), a separate and far
...
*Companions: [floating-fleet](floating-fleet.md) (the halfling fleets), [wandering dragonborn](wandering-dragonborn.md)
(the pontoon traditionalists & saints), [Amseh dynasty](amseh-dynasty.md) (the bronze-trade
world and its fall), [Musleheim](musleheim.md) (the iron empire), [Kuru & the phoenix](kuru-and-the-phoenix.md)
