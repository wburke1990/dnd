...
> Anglo-Saxon power that today leads the [reconquest of Musleheim](the-muspel-empire.md)
...
wake them again (the [comet cycle](world-history-timeline.md); cf. **Taniyn →
Lonka**, [Taniyn & Lonka](taniyn-and-lonka.md)). Each region's "god" is one of
these beasts.

Almost all of them are **one-life gods.** They fall, they reign, they become
land — and when the land breaks (as Taniyn's did at the [Bleeding Star](amseh-dynasty.md),
...
god.** They become **warforged** ([races of Nila](races-of-nila.md) places them in
...
- **Chosen transformation — for once.** Everywhere else on Nila, transformation is a
  *violation* done *to* people ([Aniess](../characters/aniess.md)'s snake-merging, the
  bound demons, the Order's rituals; [overview §3B](campaign-overview.md)). The
...
This is the **Names & Ownership thesis at its bleakest** ([overview §2](campaign-overview.md)):
...
(its [Ren](egyptian-afterlife-mythology.md)).**

In a world where **the name is the soul** and a true name lets you own and remake
its bearer ([house rules](house-rules-and-world-mechanics.md), [overview §2](campaign-overview.md)),
...
- The **crusade as symptom.** `[loose]` Kuru's aggression — the [reconquest of
  Musleheim](the-muspel-empire.md), the colonies on the Kurunatukas, the
  ...
  **mad god's hunger**: a sun-god that no longer remembers *why* it conquers, only
  ...
  operation as everyone else ([overview §3A](campaign-overview.md)) — but with a
...
- **The Muspel colony (~1,800 → ~1,600 ya).** Before this, Kuru-island was **sparsely and
  ...
  **planted a colony over them.** Crucially this came **after the empire's dragonborn had
  walked home to Jotunheim** (~1,900 ya; [Lonka §4](lonka-jotunheim.md)) — so the colonists
...
- **The lost name as the dangerous name.** The thesis promises the party will be
  ...
  recovers it could:
  - **bind it** — own the undying god outright (the [Planar-Binding horror](house-rules-and-world-mechanics.md)
    aimed at a *deity*);
  - **restore it** — *give the god back its own name and self,* the campaign's redemptive
    **chosen-transformation** counterweight to all the inflicted kinds ([overview §3B](campaign-overview.md));
...
- **The boon/curse, writ large.** `[loose]` The wild phoenix gives a **boon to those
  who take its tears** and a **curse to those who kill it** ([bestiary](../bestiary/egypt.md)).
...
*Sources / companions: [campaign overview](campaign-overview.md) (Names &
Ownership thesis; comet cycle; Kuru as dominant power),
[world-history-timeline.md](world-history-timeline.md) (comet cycle & passes),
[Taniyn & Lonka](taniyn-and-lonka.md) / [Lonka — Jotunheim](lonka-jotunheim.md)
(the one-life god that ended), [the Muspel empire](the-muspel-empire.md)
(colonization & reconquest), [the First Foundation](the-first-foundation.md)
(who founded Kuru), [house rules](house-rules-and-world-mechanics.md) (true
names), [Phoenix stat block](../bestiary/egypt.md).*
