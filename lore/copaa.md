...
> **DM reference.** [Copaa](nila-atlas.md), a town in **Suartleheim Eet**
...
> (7/28): the [Second Foundation](the-second-foundation.md) runs the ore trade, has
...
Copaa is where the [Haals](nila-atlas.md) ore comes off the water. The mine sits
...
**out of the lake to the sea,** shipped through the port at [Aar](nila-atlas.md). The
ore trade is the [Second Foundation](the-second-foundation.md)'s — the
[Company](the-company.md) on the surface, the Foundation behind it. The town is the
...
region's [rain-shadow dryness](the-drying-of-the-valley.md) — and the mine's runoff
...
- **The Company office and store.** Buys the ore, keeps the scale-book, sells the town
  everything it needs, and owns the magistrate ([the Company §4](the-company.md)).
...
- **[The Second Foundation](the-second-foundation.md)** — owns the ore trade behind the
