...
> *Iliad* — waves of **single combat and small-group duels** across a
> field, named fighters meeting named fighters, rather than one clean
> encounter. **Which side the party fights on decides which scenes they
> get to see.** The aim is to play the strangeness of the myth straight:
> the formal duels, the flowery death-lines read over each kill, the
...
## 1. The frame `[loose — brainstorm]`

The set-piece is a **pitched battle**, fought the way the *Iliad* fights:
the line breaks into **duels**. One champion steps out, names himself,
and meets another; around them, **small groups** fight their own actions.
The party moves through it as a handful of these duels, not a single
initiative order for a whole army.
...
The natural home for these battles is the **[Kuru](../../kuru/lore/kuru-and-the-phoenix.md)
war** — see §5.

**This is a kit of parts, not a plotted sequence.** We do not know how the
party will end up in [Musleheim](../../musleheim/lore/musleheim.md), or whose side they
...
The vignettes we want to stage inside the battle. Each is `[OPEN]` on
mechanics and on which side witnesses it:

- **Achilles vs. the river.** The hero fighting the river god who rises
  against him — Scamander, choked with the dead (Iliad 21).
- **The ghost of Patroclus.** The shade of the dead friend coming to
  Achilles in sleep to ask for burial (Iliad 23).
- **Hector's farewell.** Hector says goodbye to his wife and son; the
  child cries at the horsehair crest on the helmet, so Hector takes it
  off and sets it on the ground before he holds the boy (Iliad 6).

---

## 3. Read-aloud: the death-lines `[OPEN — to compile]`

The *Iliad* gives most kills a short set piece — where the spear went in,
who the man was, the father and town he came from, the way he fell. We
want a **collected list of these death-lines** so one can be **read aloud
at each death in combat**. To compile.

---

## 4. The sacrifices `[OPEN — to detail]`

The *Iliad*'s sacrifices, human and animal, are described at length and
in a fixed order — the sprinkled barley, the drawn-back heads, the cut
throats, the thighbones wrapped in fat and burned, the tasted innards.
...
## 5. The fit — the [Kuru](../../kuru/lore/kuru-and-the-phoenix.md) war and the fight over the body `[loose — brainstorm]`

These battles belong to **Kuru's** war. Kuru's holy soldiers, the
**[warforged](../../kuru/lore/kuru-and-the-phoenix.md)**, replace their hacked-off
...
orcs in [Musleheim](../../musleheim/lore/musleheim.md).** Kuru and its Order of Sunne
lead the **[reconquest of Musleheim](../../musleheim/lore/the-muspel-empire.md)**,
...
- **They travel into eastern [Musleheim](../../musleheim/lore/musleheim.md).** The east
...
- **The one god you can stab.** In Homer a mortal can wound a god —
  ...
  same stone woken to fire (see [Kuru & the phoenix](../../kuru/lore/kuru-and-the-phoenix.md)).
