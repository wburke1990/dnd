...
A caster with a true name and access to 9th level spell slots can maintain permanent binding with one casting per year. This is exactly what the dead man did for thirty-one years with his wife's true name.
...
# THE ABYSS AND DEMON SUFFERING

## The World's Structure

The world is less dense than Earth and honeycombed with tunnels. The Abyss is not a separate plane — it is the tunnel network that runs beneath all cities and extends under the sea. Every major settlement sits above Abyssal tunnels. The boundary between the surface world and the Abyss is a matter of depth, not planar travel.

This has significant implications:
- Demons do not need to cross a planar boundary to reach the surface — they simply climb
...
- Headaches, persistent and worsening with time
- Sensitivity to light — the surface is too bright, too open, too exposed
- General physical discomfort that scales with duration of surface exposure and effort expended while on the surface

A demon maintaining a humanoid disguise suffers more than one in its natural form — the effort of maintaining the shape compounds the baseline discomfort. A demon performing magical tasks while maintaining a disguise suffers more still.
...
Quasits are small and relatively weak. Their surface suffering is proportionally less severe — they can manage brief surface excursions without significant distress. This is why the wizard uses them for deliveries and errands rather than more powerful demons.

---

# PLANAR BINDING — FULL MECHANICS

*Standard 5e rules with the following modifications:*

**True name modification:** Auto-succeed on Charisma saving throw. No roll made.

**Standard casting:**
- Casting time: 1 hour
- Range: 60 feet
- Components: V, S, M (a jewel worth 1,000gp or more, consumed)
- Duration: 24 hours base, scaling with spell slot

**The bound creature:**
- Must follow commands to the best of its ability
- If hostile, strives to twist commands to achieve its own objectives
- If it completes all commands before the spell ends, it returns to report if on the same plane

**In your world specifically:**
A being bound by its true name cannot twist commands in the way a hostile bound creature normally might. The true name binding is complete — there is no meaningful resistance available to the bound being. This is why the demon wife could not leave. This is why she could not refuse the renewal. This is why she cannot know what she would have chosen.

---

# DREAM OF THE BLUE VEIL — MODIFIED CASTING

## The Poem Requirement

To cast Dream of the Blue Veil in this world, the caster must read aloud the full text of *Wynken, Blynken, and Nod* by Eugene Field as part of the 10-minute casting time. The poem functions as the verbal component of the spell — its imagery of sailing through a river of crystal light in a wooden shoe toward stars that are actually fish maps precisely onto the dream's mechanics.

The children provide a physical copy. All party casters must read it aloud together as part of the casting — the spell requires their combined voices. Non-casters are encouraged to participate for moral support. There is no mechanical reason for this. It is simply the right thing to do when someone hands you a poem at a dead man's bedside.
...
## Standard Spell Modifications

**Damage rule:** If any affected creature takes damage during the dream, the spell ends for that creature immediately. They wake up and are not transported. If the caster takes damage, the spell ends for everyone.

This makes the dream a puzzle-and-navigation challenge rather than a combat encounter. The party has no weapons, no equipment, no magic items in the dream. They wake up in white robes on a boat on a river of stars with nothing else.

**Standard spell text otherwise applies.**

---

# THE ABYSS — WORLD NOTES

The tunnel network beneath the world's surface:
- Runs under all major cities
- Extends under the sea
- Connects to the surface through natural cave systems, ancient excavations, and deliberate breaches
- Has its own geography, factions, and history that has not yet been developed
...
**The wizard's operation:**
The auto-succeed true name rule is the foundation of everything the wizard is building. He has names. Names are keys. Keys open bindings that cannot be resisted. He is building an army of beings in continuous pain who have no meaningful ability to refuse his commands. The party is helping him collect more keys.

**The demon wife:**
Thirty-one years of true name binding. No ability to resist renewal. Continuous surface suffering. Two weeks of voluntary suffering after her husband's death before she finally left. The house rules document makes the horror of her situation mechanically explicit in a way that the dream quest handles emotionally.

**The final campaign choice:**
The party will eventually be handed a true name and asked to use it. They will have read this document — or lived through its implications — before that moment arrives. They will know exactly what using it means.

**Wynken, Blynken, and Nod:**
The poem is a children's lullaby about sailing through stars in a wooden shoe. The party reads it aloud around a dead man's body with doll-sized white robes on the windowsill and falls asleep on a boat on a river of stars. The tonal juxtaposition — innocence of the poem against the weight of what follows — is intentional and should be preserved. Do not explain it. Just hand them the poem and let them read it.

---

*End of House Rules and World Mechanics document.*
