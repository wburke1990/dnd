...
> goals, themes, and design principles — and points to where everything else
> lives. `[OPEN — …]` markers are decisions still to be made; answer them inline
> or in conversation and they'll be folded in.
...
- **Transformation** (binding, the Order's rituals, the snake-island rites) is
  changing *what someone is* — usually done *to* them, without consent.
- **The name quest** is the literal mechanic of that power: a true name lets you
...
### A. Subversion & Anti-Colonialism
*David's domain (international relations / anti-colonialism). Will (the other DM)
asks to be actively pushed in this direction while brainstorming.*
...
[Egyptian afterlife mythology](../../suartleheim-eet/maalm/lore/egyptian-afterlife-mythology.md)).
...
- **Maalm** — conquest-city built atop the ruined Amseh empire and over the place
  where **Ammit** sleeps (see [the founding](../../suartleheim-eet/maalm/lore/maalm-founding.md)).
...
- **Mixed peoples — no single-species cities (yet).** Fast mutation and constant
  ...
  pure (see [the Muspel empire](../../musleheim/lore/the-muspel-empire.md)).
- **The comet cycle & a world in flux** — a ~1,000-year comet cycle drives
  ...
  reshaped the world 5,000 years ago (see [Amseh dynasty](../../suartleheim-eet/maalm/lore/amseh-dynasty.md)).
  ...
  [the Second Foundation](the-second-foundation.md) / [Lonka — Jotunheim](../../lonka/lore/lonka-jotunheim.md)).
- **The hot spot (where new land comes from).** The volcanism is a **moving hot spot**
  ...
  **Noku** is not new at all — old, depopulated ground south of drowned Cartaga,
  ...
  [client-states](../../kuru/lore/kuru-and-the-phoenix.md).
- **Dragons and demons follow the hot spot.** Wherever the hot spot sits is the place of
  **maximum heat, magic, and land-generation** — and **both primordial forces are drawn to
  ...
  - **Across Musleheim** (the middle passes): the hot spot **built the fire-island** and,
    with it, the [Muspel empire's](../../musleheim/lore/the-muspel-empire.md) land-power.
...
client-states** as the orc wars turned against Kuru (see [Kuru & the phoenix §5](../../kuru/lore/kuru-and-the-phoenix.md))
...
**[Jotunheim dragonborn fleet](../../lonka/lore/lonka-jotunheim.md)**, sailing to Moku to take the island
...
- `[OPEN]` Central question the campaign argues, and the ending image/choice.
- `[OPEN]` Is the arc fundamentally "realize what you're part of, then decide"?
- `[OPEN]` Which colonial structure is foregrounded; role of orcs/half-orcs.
- `[OPEN]` Transformation: chosen-and-good vs. violation.
...
- **`lore/`** — worldbuilding & DM references: this overview,
  ...
  [the drying of the valley](../../suartleheim-eet/maalm/lore/the-drying-of-the-valley.md),
  [Maalm founding](../../suartleheim-eet/maalm/lore/maalm-founding.md),
  [Bedraageon Square (Maalm's civic heart)](../../suartleheim-eet/maalm/lore/bedraageon-square.md),
  [satyrs run the taverns (the Letaps)](satyr-taverns.md),
  [Amseh dynasty](../../suartleheim-eet/maalm/lore/amseh-dynasty.md),
  [Egyptian afterlife mythology](../../suartleheim-eet/maalm/lore/egyptian-afterlife-mythology.md),
  ...
  [sailing the archipelago (crewing, weather, storms)](../../the-sea/lore/sailing-and-storms.md),
...
- **`characters/`** — PCs (Sarric, Aniess, Jasper, Pax) and NPCs (Preem,
  ...
  psychic bat).
- **`encounters/`** — [Valley of the Kings](../../suartleheim-eet/maalm/encounters/valley-of-the-kings.md),
  [The Dream Quest](../../suartleheim-eet/maalm/encounters/the-dream-quest.md),
  [The Haals Runoff (first eco-terror job)](../../suartleheim-eet/raand-copaa/encounters/the-haals-runoff.md),
  [The Gates of Kala (silent sentries of the underworld)](../../kalikhat/encounters/the-gates-of-kala.md),
...
- **`bestiary/`** — [the Egypt encounter table](../../suartleheim-eet/maalm/bestiary/egypt.md), [the sea-beasts table (world-myth ocean encounters)](../../the-sea/bestiary/sea-beasts.md), [available demons (stat-block roster)](../bestiary/available-demons.md).
