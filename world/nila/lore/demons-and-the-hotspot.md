...
demon and the demon-people, where the demon-people live, the old alliance
that raised Muspelheim, and how that alliance fell apart. Companion to
[the First Foundation](the-first-foundation.md),
[the Second Foundation](the-second-foundation.md),
[Kuru and the Phoenix](../../kuru/lore/kuru-and-the-phoenix.md), and
...
The hotspot migrates over the ages — Lonka, then Muspelheim, then the
Kurunatukas (see the hotspot chain in
[the campaign overview](campaign-overview.md)). The demon-people migrate with
it, because their cities run on its heat. The Abyss is the tunnel-network that
...
- **Beneath Muspelheim** — an older city, emptied as the heat moved south.
- **Beneath the Kurunatukas (Noku and Moku)** — the living city, where the
  demon-people are now. This is why demons are appearing on Moku in the present
  day: the heat, and they, have arrived there.
...
1. The dragonborn drifted from their old roaming dragon-faith toward a
   place-bound, zealot form of it. Internal political rifts pushed them out of
   Muspelheim at the same time their faith pulled them back toward Lonka. They
   left.
...
of the [Amduat](../../suartleheim-eet/maalm/lore/egyptian-afterlife-mythology.md), *to give the dead the names
...
## The name is held by one demon, and it must be taken

The magma demon's name is not common knowledge among the demon-people. Ordinary
demons — Manizheh among them — have never had access to it. It rests with one of
the **greatest demons of the deep**, an ancient keeper that has lived closest to
the force, for the longest.

There is only one way to get it, and it is the same way any true name is taken:
