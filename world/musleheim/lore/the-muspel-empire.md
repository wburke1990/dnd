...
> turned its own people into **orcs and half-orcs**, the Viking-analog raiding age
> that followed, and the present war that has driven the orcs back to their
> homeland — with **Kuru** and its **Order of Sunne** leading the reconquest.
> Norse register (Musleheim = **Muspelheim**, the realm of fire). Dates are anchored
> to the [comet cycle](../../nila/lore/world-history-timeline.md); `[OPEN]` flags the soft spots.
>
...
- **Kuru began as a Muspel colony (founded ~1,800 ya).** The empire planted it **after its own
  dragonborn had left** for Jotunheim (~1,900 ya, [Lonka §4](../../lonka/lore/lonka-jotunheim.md)), so the
  colonists were **nearly all human** — which is why Kuru is the men-dominated society it still
  is (see [Maalm — the elven stronghold](../../suartleheim-eet/maalm/lore/maalm-the-elven-stronghold.md), which notes Kuru is
  ruled by men as Maalm is by elves). Kuru then **rebelled and broke
  free** — the war that birthed its phoenix-faith (see [Kuru & the phoenix](../../kuru/lore/kuru-and-the-phoenix.md))
...
- **The pre-mutation Muspel folk were human** — *mostly* human, at least. The
  **half-orcs** the change later produced are simply the change *taken halfway*, which
  ...
  fire-cult, Norse-flavoured maritime power.
- **Worldbuilding rule — no single-species cities (yet).** Fast mutation and constant
  migration mean **every city is mixed**; there is no one-people settlement anywhere in
  the world. Regions *skew* — Maalm elf-elite, Kuru man-heavy, Musleheim orc-heavy —
...
where **there isn't enough land and what there is is exhausted** ([overview §5](../../nila/lore/campaign-overview.md)),
the Muspel empire's strength came from the **same mechanism now driving the
[Kurunatuka land rush](../../kuru/lore/kuru-and-the-phoenix.md):** they **controlled the fertile land —
and a great deal of it — because they controlled the cyclical events** that make it.
Working through (or hand-in-glove with) the [First Foundation](../../nila/lore/the-first-foundation.md),
...
on its long southeast drift out of Lonka ([overview §5](../../nila/lore/campaign-overview.md)), raising
...
the same convergence now beginning over the [Kurunatukas](../../kuru/lore/kuru-and-the-phoenix.md). 🔒 Which is exactly why the
[Second Foundation](../../nila/lore/the-second-foundation.md)'s sabotage of that control (§2) was so
...
## 2. The Mutation — the comet remakes the empire (~1,000 ya)
...
🔒 And it was **no accident:** the [Second Foundation](../../nila/lore/the-second-foundation.md) had
infiltrated the [First Foundation](../../nila/lore/the-first-foundation.md) — the men and dragonborn
...
(See the [Nila atlas](../../nila/lore/nila-atlas.md) for positions.) `[OPEN]` whether anything
...
- **Earth genasi** `[Will 7/29]` where it worked on the body a different way — the flesh
  ...
  [Jasper's rock is superficial](../../nila/lore/lineages-and-afterlives.md) (§7).
...
[Lonka — Jotunheim](../../lonka/lore/lonka-jotunheim.md)), so a thousand years on **much of Musleheim is
...
zero-sum trade** (see [campaign overview §5](../../nila/lore/campaign-overview.md)). Orc and half-orc
...
Tyre — see [wandering-dragonborn](../../the-sea/lore/wandering-dragonborn.md); these orcs keep only the
...
The Viking parallel carries through to the end. The lands the orcs raided were
**transformed by the very wars waged on them**: scattered peoples unified, militarized,
and built the institutions that could finally answer Musleheim.

- Foremost among them is **Kuru** — *itself a former Muspel colony* — and its crusader
  **Order of the Emplere Cnihtas**, the militant arm of the religion of **Sunne**, run
  behind the scenes by its Warforged leadership (see [Aniess](../../../characters/aniess.md)).
- Over the last few centuries the orcs have been **beaten back from most of their
  holdings**, their reach contracting island by island toward home.

The colonized became the reconqueror — and the reconquest is, in its turn, colonial.
...
> (the zero-sum land/food world of [campaign overview §5](../../nila/lore/campaign-overview.md)), waged
> by a whole people in arms. The *trade*-Phoenician side lives with the **dragonborn**
> (Lonka as Tyre — see [wandering-dragonborn](../../the-sea/lore/wandering-dragonborn.md)).
...
- **The siege of Anklia.** At the campaign's height she lays siege to **Anklia** (a Kuru
  city — see [Nila atlas](../../nila/lore/nila-atlas.md)) — a *Hannibal ad portas* beat: the siege
...
- **A Zama — at Ilka Mak (settled — 7/2).** Kuru's own counter-offensive stalls out
  ...
  **symbolic transfer of power** as a military one — proof Noku can do what Kuru
  ...
  [Noku] gains" (see [Kuru & the phoenix §5](../../kuru/lore/kuru-and-the-phoenix.md)). `[OPEN]` Exact
...
- **The tavern reveal.** `[OPEN — seed, 7/2]` If she survives the Zama: her real-world
  ...
  **Staged `[draft — 7/26]`:** the party first meets her at a tavern near Copaa,
  where she offers help against the [Company](../../nila/lore/the-company.md)'s Haals mine — see
  [the Haals runoff §4](../../suartleheim-eet/raand-copaa/encounters/the-haals-runoff.md). That job also writes
...
- **How the orc sea fell — two legendary battles.** `[Will, 6/26]` The Muspel ruled Nila's
  ...
  **(1) the Battle of Svolder (~320 ya) — orc against orc:** the Muspel were never one people again after the Bad Pass (Ragnarok II) — its alchemical sickness mutated them into orcs, half-orcs, and worse, shattering their old unity — and
  their sea-power first cracked in a ruinous *civil* battle, king against king. **(2) the Battle of Hjörungavágr (~300 ya) — orc against the [Suartleheim dwarves](../../the-sea/lore/ships-and-sea-power.md):**
...
- **A fallen sea-power now.** Most Muspel longships were lost in those wars (Annibel/Hannibal's is
  ...
  naval picture: [ships & sea-power](../../the-sea/lore/ships-and-sea-power.md).
...
- The fighting has reached **Musleheim itself.** The orcs are **pushed back to their
  homeland**, defending the ground where the comet first remade them.
- **Kuru leads the reconquest,** the Order of Sunne at its head. Whether that is
  liberation, vengeance, or simply colonialism running the other direction is exactly
  the question the campaign would have the table sit with.
- **Half-orcs**, mutated at the margins and long scattered, are spread through the
  wider world far more than the homeland-bound orcs — you meet them everywhere (cf.
...
them:** the [Company](../../nila/lore/the-company.md) out of [Noku Kurunatuka](../../nila/lore/nila-atlas.md) is **muscling
...
business. (See [the Company](../../nila/lore/the-company.md).)

---

## 7. The Lost Northern Colonies & the Ice Frontier

The Norse register runs all the way to the top of the map. In their raiding age the
Muspel orcs planted **colonies out across the cold sea** — three remembered names, our
**Iceland, Greenland, and Vinland**:

- **Contact has been lost** with all three. The orcs *know they exist* — sagas, old
  manifests, family names — but no ship has come back from them in living memory. (Our
...
- **Strange beasts on the ice** — the far north's wildlife rendered huge and
  monstrous: towering flightless sea-birds that hunt in ranks (penguin-analog), white
  bears the size of barns (polar-bear-analog), and worse past the floe-edge.
- **The sealskin folk** — strange humanoids who travel in **sealskin canoes** and wear
  **sealskin snowsuits** (our Thule / Inuit; the Norse *Skræling*). The colonists
  traded and fought with them, and the sagas can't agree whether they are men, spirits,
  or something else. They were on the ice before the colonies, and they remain after.

`[OPEN]` Stat the ice-beasts and the sealskin folk for the [bestiary](../bestiary/)
when the northern front comes into play. `[OPEN]` whether any lost colony survives, and
in what state — gone native, besieged, or turned into something out on the ice.

---

## Campaign connections

- **Resolves** the [campaign-overview](../../nila/lore/campaign-overview.md) open question of *where the
  orcs and half-orcs fit.*
...
- **Two Punic threads, split (resolved).** The *trade-and-colony* Phoenicians are the
  **dragonborn** (Lonka as their **Tyre**, the **Lost Tribes** their scattered colonies
  — see [wandering-dragonborn](../../the-sea/lore/wandering-dragonborn.md)); the **Punic War** itself — Annibel/Hannibal, the
