---
summary: Stat blocks for the merfolk and merrow who strip drifting wrecks, tuned for five level-3 PCs
status: ready
---
...
*Medium humanoid (merfolk), neutral* · **CR 1/4 (50 XP)**
...
- **Fish-Spear.** *Melee or Thrown:* +3 to hit, reach 5 ft. or range 20/60 ft.
  *Hit:* 4 (1d6 + 1) piercing.
- **Gaff-Hook.** *Melee:* +3 to hit, reach 5 ft. *Hit:* 3 (1d4 + 1) slashing, and the
  target makes a **DC 11 Strength** save or is pulled 5 ft. toward the rail. A creature
  pulled off the edge lands in the water.

### Reactions

- **Slip the Rail.** When a creature it can see hits it with a melee attack, the merfolk
  drops over the side into the water and swims 20 ft. It cannot use this if it is
...
*Medium monstrosity, neutral evil* · **CR 1 (200 XP)**
...
**Drowner.** Has advantage on attack rolls against a creature in the water that has no
swimming speed.

### Actions

- **Bite.** *Melee:* +5 to hit, reach 5 ft. *Hit:* 6 (1d6 + 3) piercing.
- **Harpoon.** *Melee or Ranged:* +5 to hit, reach 5 ft. or range 20/60 ft.
  *Hit:* 8 (1d10 + 3) piercing, and a Large or smaller target is **grappled** by the
  line (escape **DC 13**). The merrow can hold only one creature at a time.
- **Haul In.** *(Only against a creature grappled by its harpoon.)* The merrow drags the
  creature **15 ft.** toward itself. If that takes the creature over the side, it is in
  the water, and the merrow can Haul In again next turn to pull it under.
...
- *Easier:* one harpooner instead of two, and hold the second wave of salvagers back
  until the first is beaten.
- *Harder:* both harpooners in the water on opposite sides, harpooning off the flanks
  while the salvagers push people toward the rail.
