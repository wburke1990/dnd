...
halfling Floating Fleet's ship-to-ship war on Kuru's hired hulls, and the
Dragonborn amphibious landing on Moku. Worked out 7/22 to set up two
late-campaign set-pieces and to seed hints back into the two orc sagas
...
### The Floating Fleet's wind — the druids' following wind

The halfling Fleets are thick with druids, who grow and mend the timber (see
[floating-fleet](floating-fleet.md)). To move the whole Fleet they cast
**Control Weather** (8th level), turning the wind to a steady following wind on
every hull at once. The sign the party gets: a wind that rises out of a flat calm
and holds against the real weather, hours before any sail crests the horizon.
Behind it come the whale-bladder drums.

There is a hook for this already in canon. The saint **Anzar the Island-Fisher**
"stole the trade-winds and corked them in a wineskin" (see
[wandering-dragonborn](wandering-dragonborn.md)). A Fleet raising its wind is the
wineskin uncorked — the myth read as a working. **[draft]**

### The Dragonborn fleet's wind — the hot wind at night

The Dragonborn fleet does not run on druids. Its casters and its demon allies
raise a different wind: a hot wind off a cold sea, ash carried on it, arriving at
night. The demons keep to the dark — they sicken in open sun (see
[demons-and-the-hotspot](../../nila/lore/demons-and-the-hotspot.md)) — so the fleet makes its
crossings and its landings after sundown, and the hot wind goes before. A crew
...
**The matchup.** The Second Foundation's bound demon army holds the Moku shore —
the demon-people arrive on Moku with the hotspot (see
[demons-and-the-hotspot](../../nila/lore/demons-and-the-hotspot.md)). By the time the party
reaches the high levels, this army is the thing they most fear. The Dragonborn
fleet comes ashore against it at night, its own demons — rakshasas among them —
...
[available-demons](../../nila/bestiary/available-demons.md),
...
- So the free demons do not fight to kill their bound kin. They cut through the
  line toward the Second Foundation binders, because a dead binder frees every
  demon that elf held. The bound demon on the sand goes down glad — it is a way
  home, and maybe a way to wake up free. Two who knew each other before the
  binding meet, embrace, and then have to swing; the one who melts away is the
  fortunate one, if its binder falls before it is called back.
- Write the dialogue on that footing: friendly all through the fight they are
  forced to have, the bound one naming the elf whose death would free it as it
...
[the-second-foundation](../../nila/lore/the-second-foundation.md),
[demons-and-the-hotspot](../../nila/lore/demons-and-the-hotspot.md)); here the same two peoples
...
[demons-and-the-hotspot](../../nila/lore/demons-and-the-hotspot.md),
[campaign-overview](../../nila/lore/campaign-overview.md),
[world-history-timeline](../../nila/lore/world-history-timeline.md)). They are a third power in the
...
[demons-and-the-hotspot](../../nila/lore/demons-and-the-hotspot.md)). So the city rises against the
...
[demons-and-the-hotspot](../../nila/lore/demons-and-the-hotspot.md)) — so the beach sits over the
...
[campaign-overview](../../nila/lore/campaign-overview.md)); the dragonborn *mean* to re-seat dragons
on Moku (see [lonka-jotunheim](../../lonka/lore/lonka-jotunheim.md)), but the sky-dragon is held for
the climax — the volcano, with the star falling (the Ragnarok pass; see
[the-second-foundation](../../nila/lore/the-second-foundation.md)). On the beach the dragon stays a
...
1. **A dragonborn comes to recruit Blackacre.** The first warning, and the front
   end of the finale ask — the Jotunheim dragonborn wanting Blackacre to lead the
   fleet to Moku (see [blackacre](../../../characters/blackacre.md),
   [lonka-jotunheim](../../lonka/lore/lonka-jotunheim.md)). The party need not read it as a fleet
   yet.
2. **Hidden ships at Jotunheim.** If they go there, most of the fleet is out of
   sight; they can learn how a dragon-boat is built (the lashed hull) without
   learning how the fleet fights.
3. **The mage wind.** The hot wind at night is the second sign — the one that says
   it is now.
4. **The landing.**

**The Floating Fleet is not a secret the same way.** The party may meet it in
...
- **Hjörungavágr already holds the pieces.** Dark sea-patrons (the troll-women)
  ...
  from under a fleet; a storm that drowns the survivors on the voyage home. The
  first prefigures the demon host at Moku; the second the water- and fire-magic of
  both battles; the third the weather-working that goes before a fleet. And the
  eruption there is the **same hotspot that raised Moku** — so the saga that broke
  the orc sea and the ground the Dragonborn fleet lands on are one place.
  **[draft]**
- **Svolder** — longships lashed gunwale-to-gunwale, boarded deck by deck, and a
...
- [lonka-jotunheim](../../lonka/lore/lonka-jotunheim.md) — the Dragonborn fleet and the Moku
  finale.
- [the-second-foundation](../../nila/lore/the-second-foundation.md) — the bound demon army and
  Preem.
- [demons-and-the-hotspot](../../nila/lore/demons-and-the-hotspot.md) — bound vs. free demons;
