...
> Anglo-Saxon power that today leads the [reconquest of Musleheim](../../musleheim/lore/the-muspel-empire.md)
> — told through the thing that made it: a **comet-born phoenix**, the one
> god on Nila that does not stay dead. Kuru is referenced all over the lore
> (it's a major polity); this is its home file. Legend: `[settled]` agreed ·
...
>
> See also [Demons, the Hotspot, and the Deep Cities](../../nila/lore/demons-and-the-hotspot.md) —
...
Every comet pass, **sentient space-stone falls from the sky.** The stones wake
as mythic beasts — dragons, dragon turtles, giant snakes — live an age, then
**settle into islands and harden back into stone**, waiting for the next pass to
wake them again (the [comet cycle](../../nila/lore/world-history-timeline.md); cf. **Taniyn →
Lonka**, [Taniyn & Lonka](../../lonka/lore/taniyn-and-lonka.md)). Each region's "god" is one of
these beasts.

Almost all of them are **one-life gods.** They fall, they reign, they become
land — and when the land breaks (as Taniyn's did at the [Bleeding Star](../../suartleheim-eet/maalm/lore/amseh-dynasty.md),
leaving only [heart-stone shards](../../lonka/lore/lonka-jotunheim.md)), the god is simply *gone.*
...
## 2. The Fall — how the phoenix made Kuru

`[settled]` The **phoenix-stone fell long ago and became the land of Kuru
...
holy **Lonka** and seeded the dragon-blooded peoples ([campaign overview §5](../../nila/lore/campaign-overview.md));
...
the wild [Phoenix on the encounter table](../../suartleheim-eet/maalm/bestiary/egypt.md) is only a small,
feral echo (same trick at small scale: at 0 HP it bursts into fire and reforms
from its ashes in days). The god does it at the scale of an age.
...
and from him the **[Order of Sunne](../../nila/lore/campaign-overview.md)** descends.

This is the **Names & Ownership thesis in one image** ([overview §2](../../nila/lore/campaign-overview.md)):
to gain power he **takes a piece of a god into his own body** — *owning* a
fragment of the divine, *remaking* himself with it. The whole campaign's
question — *what kind of power is the power to take and remake?* — is written
into the founder's wrist.

**What this seeds:**

- **"Sunne" is the phoenix.** `[loose]` The Order of Sunne and its crusader knights
  (the **Order of Emplere Cnihtas**, [Aniess](../../../characters/aniess.md)) venerate the
  **sun that dies each night and rises each dawn** — which is, secretly, the literal
  **phoenix that dies each age and rises again.** 🔒 Whether the rank-and-file know
  their god is a *beast made of fallen stone* is a reveal to hold — but the leadership
  (below) knows it intimately, because they are made of the same stone. Capital
  **Ankalia**, commercial city **Ekkek** ([Aniess](../../../characters/aniess.md)).
- **The stone speaks.** `[settled]` **Anyone with a piece of the sentient stone
  embedded in their body hears voices** — which they take for **the voice of their
  god.** This is how Kuru receives revelation, prophecy, and command: not metaphor,
  but the **living god-stone whispering through the flesh of those who carry it.**
  🔒 And because the phoenix is going mad (§4), what the stone whispers is getting
  *worse* — the Church hears a failing mind.
...
- **When the faith was founded** `[settled]` — in **Kuru's war of independence from the
  Muspel empire (~1,600 → ~1,450 ya, §5).** The phoenix-*stone* fell at Creation (§2), but
...
`[settled]` The founder's bargain is the **template for the whole religion.** Just
as the phoenix seeks **a kind of mortality through transformation** — surviving by
being remade — **its worshippers seek the same.** Over a lifetime, the devout
**replace their flesh, piece by piece, with parts of the stone — parts of their
god.** They become **warforged** ([races of Nila](../../nila/lore/races-of-nila.md) places them in
Kuru): not manufactured soldiers but **converts who have transformed all the way
in.** The **warforged are the leaders of the Church of Sunne,** and they are
**nearly immortal.**

This is dense with the campaign's themes:

- **Chosen transformation — for once.** Everywhere else on Nila, transformation is a
  *violation* done *to* people ([Aniess](../../../characters/aniess.md)'s snake-merging, the
  bound demons, the Order's rituals; [overview §3B](../../nila/lore/campaign-overview.md)). The
  warforged choose it for themselves. `[settled]` But **the immortality transformation
  comes with a cost: just like their god, the warforged lose their identity.** The
  more stone replaces flesh, the more they forget who they were — trading away their
  humanity, their memory, their *self* for endurance, on the same terms the phoenix
  pays at the scale of an age. The Order **does to outsiders exactly what its leaders
  do to themselves** — which is why it can do it with a clear conscience.
- **They hear the god loudest.** The more stone you carry, the more of the god's voice
  you hear — so the warforged leadership lives **inside the phoenix's mind.** 🔒 As that
  mind fails (§4), **the Church's own rulers are going mad with their god,** mistaking
  its broken whispers for fresh commandment. The crusade may be exactly that: a
  dying god's confusion, relayed as holy war by priests who can no longer tell.
...
- **Puppet or person?** `[OPEN]` At the far end of conversion — most flesh gone,
  ...
  puppets of the phoenix godstone** speaking through them. The same uncertainty that
  hangs over the god (§4) hangs over its eldest priests: is anyone *home,* or is it
...
helps explain catastrophes like the first crusades to [Kalikhat](../../nila/lore/campaign-overview.md)
(§5), and compounds Kuru's already-thin navy ([overview §5](../../nila/lore/campaign-overview.md)).
...
Anubis](../../suartleheim-eet/maalm/encounters/the-dream-quest.md#the-small-anubis--what-the-rite-requires)** —
...
**explodes** (the Manichean Ragnarok frame; [overview §5](../../nila/lore/campaign-overview.md),
[Lonka — Jotunheim](../../lonka/lore/lonka-jotunheim.md)). The phoenix is a **sky-beast of fallen
...
([overview §2](../../nila/lore/campaign-overview.md)): to **name yourself is to claim yourself,** and
...
are **nodes of a single mind.** The religion is best described as a **hive mind,**
and **the degree of membership is proportional to the amount of stone in the
body.** A pilgrim with a chip in a finger feels only a faint pull and the
occasional whisper; a half-converted knight shares much of the god's sense and
will; an ancient warforged elder is **almost wholly subsumed** — which is exactly
why it's unclear whether anyone is still home (above). To take the stone is to
**join the chorus,** and to take more is to **dissolve into it.**

`[settled]` **The bond has soured.** It **began symbiotic** — the stone gave its
bearers power and a god's guidance; the bearers gave the god worship, continuity,
and hands in the world. But **over the ages it has turned parasitic.** As the
phoenix declines (§4), it **takes more than it gives** — drawing the memory, will,
and self out of its faithful to shore up its own failing mind. The hive no longer
serves its members; **the members feed the hive,** and the hungriest, maddest god
on Nila is at the center of it, eating its own church by degrees.

This is the **Names & Ownership thesis at its bleakest** ([overview §2](../../nila/lore/campaign-overview.md)):
the worshippers of Kuru are being **owned and remade** — not by a conqueror with a
true name, but by **their own god, with their own consent, one shard at a time.**
🔒 It also means the Church keeps no secrets from itself and is very hard to turn
or infiltrate (the stone hears what its bearers hear) — but a **mad** hub means the
...
- **Vigil (V1G1L) — the mist-warforged of Kalikhat,** the **mist crusader.** 🔒 An
  ...
  [Kalikhat](../../nila/lore/campaign-overview.md)** — once an honorable city that, in some old
  ...
  *(Inspiration: **Aridhol / Shadar Logoth**, the fog **Mashadar**, and **Mordeth** —
  ...
  failed early colony** on [Kalikhat](../../nila/lore/campaign-overview.md) — **a Jamestown** that
...
(see [the Amseh dynasty](../../suartleheim-eet/maalm/lore/amseh-dynasty.md) and
[Valley of the Kings](../../suartleheim-eet/maalm/encounters/valley-of-the-kings.md)). Sail there and they
...
**snake-merging done *to* recruits** ([overview §3B](../../nila/lore/campaign-overview.md)).
...
that the redemptive, **self-chosen** transformation ([overview §3B](../../nila/lore/campaign-overview.md))
...
`[settled]` **Every rebirth costs the phoenix something,** and what it loses is
**itself.** The fire that remakes the body also **burns the memory.** Each cycle
the god wakes a little emptier — forgetting the age it just lived, then the
worshippers it loved, then its own deeds, and at last 🔒 **its own true name
(its [Ren](../../suartleheim-eet/maalm/lore/egyptian-afterlife-mythology.md)).**

In a world where **the name is the soul** and a true name lets you own and remake
its bearer ([house rules](../../nila/lore/house-rules-and-world-mechanics.md), [overview §2](../../nila/lore/campaign-overview.md)),
a god that is **forgetting its own name is losing its soul piecemeal, by fire, on
schedule.** That is the phoenix's curse, and the exact **inverse of the name
quest** — where the party *gathers* names, the phoenix is *shedding* its own.

`[settled]` **In the present it is going mad.** It is ancient now, many rebirths
deep, and **losing its grip on its sense of self, its memories, and its
identity.** Signs the DM can seed:

- The god's **blessings turn erratic and cruel** — harvests that burn, dawns that
  don't come, omens that contradict last year's. The Order works harder to
  explain them away. 🔒
- The phoenix **mistakes the living for the long dead** — addresses new priests by
  the names of worshippers ash for millennia; demands rites no one remembers the
  reason for; grieves people no one can identify.
- The **crusade as symptom.** `[loose]` Kuru's aggression — the [reconquest of
  Musleheim](../../musleheim/lore/the-muspel-empire.md), the colonies on the Kurunatukas, the
  beachheads — reads on the map as ordinary empire, but underneath it may be a
  **mad god's hunger**: a sun-god that no longer remembers *why* it conquers, only
  that it must, demanding more land, more fire, more names. *The same colonial
  operation as everyone else ([overview §3A](../../nila/lore/campaign-overview.md)) — but with a
  failing god at the bottom of it.*

`[loose]` 🔒 **Why it's accelerating now.** The **~1,000-ya bad pass** that the
[Second Foundation](../../nila/lore/the-second-foundation.md) sabotaged mutated the
[Muspel](../../musleheim/lore/the-muspel-empire.md) into orcs and also **botched the phoenix's rebirth,**
...
## 5. Kuru through the ages (chronology)

A Kuru-eye view; the master timeline is [world-history-timeline.md](../../nila/lore/world-history-timeline.md).

- **The Fall (~6,000 ya).** `[settled]` Phoenix-stone falls at the first drop, alongside
  Taniyn; becomes the island of Kuru. Sibling-land to Taniyn's [Lonka](../../lonka/lore/taniyn-and-lonka.md). §2.
...
- **The Muspel colony (~1,800 → ~1,600 ya).** Before this, Kuru-island was **sparsely and
  ...
  Then the First-Foundation-led **[Muspel empire](../../musleheim/lore/the-muspel-empire.md)** spread outward and
  **planted a colony over them.** Crucially this came **after the empire's dragonborn had
  walked home to Jotunheim** (~1,900 ya; [Lonka §4](../../lonka/lore/lonka-jotunheim.md)) — so the colonists
  were **nearly all human,** which is why Kuru is the **man-dominated** society it still is.
  (Canon's *"[the First Foundation founded Kuru](../../nila/lore/the-first-foundation.md)"* and *"the Muspel
  ...
  its own god.
- **The Rebellion & the stone hand (~1,600 → ~1,450 ya) — the faith is born.** `[settled]`
...
- **The Kalikhat Crusades (~1,400 → ~1,150 ya) — Kuru's *first* crusading era.** `[settled]`
  Independent now, the phoenix-cult pushed **colonies onto [Kalikhat](../../nila/lore/campaign-overview.md)**
  ...
  **not knowing the region's people had fled *underground*** after the Bleeding Star
  ([overview §5](../../nila/lore/campaign-overview.md)). The colonists ran headlong into the world below —
...
- **The orc wars (~last 600 years).** `[settled]` Per the timeline, the **last ~600
  years have been consumed by war with the orcs of [Musleheim](../../musleheim/lore/musleheim.md)** — the
  Viking-age raiding resurgence and the long reconquest that followed
  ([Muspel empire](../../musleheim/lore/the-muspel-empire.md)). Kuru is a **martial society by its very
  ...
  **natural force to check the orcs' expansion and raids,** and rode that role to its
  present dominance and the **lead in the reconquest of Musleheim** ([overview §3A](../../nila/lore/campaign-overview.md)).
- **The Musleheim Reconquest (~300 ya → now) — Kuru's *second* crusade.** `[settled]`
  ...
  of Sunne outward again — the long **reconquest of [Musleheim](../../musleheim/lore/the-muspel-empire.md)** is
  its **second great holy war,** a later and larger turn of the same colonial pattern as the
  Kalikhat crusades (above; [overview §3A](../../nila/lore/campaign-overview.md)).
- **The Kurunatuka land rush (recent).** `[settled]` A running truth of the world:
  **there isn't enough land, and what there is is exhausted** ([overview §5](../../nila/lore/campaign-overview.md)).
  ...
  old lands like [Maalm](../../suartleheim-eet/maalm/lore/maalm-the-elven-stronghold.md).** **Noku rode the same rush
  for a different reason:** not new soil but old, depopulated ground — the
  orc-resettled southern reach of drowned Cartaga (see
  [Musleheim](../../musleheim/lore/musleheim.md)) — conquered rather than claimed empty. Either way it's
  ...
  *(Moku's rise is the **same mechanism that first built the
  [Muspel empire](../../musleheim/lore/the-muspel-empire.md)** — power from controlling the cycle that
...
- **Now (~1 year to the next pass).** Kuru is the **dominant power** but **weak at sea**
  ([overview §5](../../nila/lore/campaign-overview.md)) — the gap [Sam's floating fleet](../../the-sea/lore/floating-fleet.md)
...
- **The Musleheim front — the shaky alliance (now).** `[settled]` The orc war (above) is
  currently prosecuted by an **alliance of Kuru and [Noku Kurunatuka](../../nila/lore/campaign-overview.md)**
  against the **tribes of [Musleheim](../../musleheim/lore/musleheim.md)** — and it is **strained near
  breaking:**
  - **Two beachheads on the big island, both stalled.** **Kuru holds Calaik** (a
    ...
    (see [the Muspel empire §5](../../musleheim/lore/the-muspel-empire.md)), Noku's own
  ...
  - **The Annibel/Hannibal wound.** A string of **defeats to [Annibel/Hannibal](../../musleheim/lore/the-muspel-empire.md)**
  ...
  - **No navy — borrowed ships.** `[settled]` **Neither power has much of a navy;** both
    depend on **mercenary pirate ships out of [Mukka](../../nila/lore/campaign-overview.md)** to ferry
  ...
  - 🔒 **The coming reversal (planned beat).** `[loose]` That supply line is about to
    ...
    **tribes hit them very hard.** A second great reversal of the war. **Which side (if
    ...
    campaign is built for ([overview §4](../../nila/lore/campaign-overview.md)).
  - `[settled]` **From colonies to clients.** **Both Noku and Moku Kurunatuka began as
    ...
    [Second Foundation](../../nila/lore/the-second-foundation.md)'s secret finale ground — its growing
    autonomy is part of how that control stays hidden; [overview §6](../../nila/lore/campaign-overview.md).)*

---

## 6. The coming pass — the phoenix's next death 🔒

The campaign opens **~1 year before the next comet pass** ([overview §5](../../nila/lore/campaign-overview.md))
...
- **A rebirth that fails.** 🔒 If the god dies into this pass too far gone, it may
  **not come back as itself** — or not come back at all. A sun that does not rise is
  ...
  [Foundations](../../nila/lore/the-second-foundation.md) are fighting over.
- **The hot spot has arrived under Moku Kurunatuka.** `[settled]` The pass's **biggest
  ...
  ([overview §5–6](../../nila/lore/campaign-overview.md)) — which is why **demons are now appearing there,
  with rumors of dragons too:** both primordial forces converge wherever the hot spot is
  (*dragons and demons follow the hot spot*, [overview §5](../../nila/lore/campaign-overview.md)). The
  newest land is becoming the **stage of the coming dragon-vs-demon contest** — the same
  kind of clash that once shattered [Lonka](../../lonka/lore/lonka-jotunheim.md) — and Kuru's client-state
  Moku is sitting on top of it (and secretly in [Second Foundation](../../nila/lore/the-second-foundation.md)
  hands).
- **The lost name as the dangerous name.** The thesis promises the party will be
  "handed that power — **over a god,** a demon, maybe a person" ([overview §2](../../nila/lore/campaign-overview.md)).
  🔒 The phoenix's **forgotten true name** is a strong candidate for that name. Whoever
  recovers it could:
  - **bind it** — own the undying god outright (the [Planar-Binding horror](../../nila/lore/house-rules-and-world-mechanics.md)
    aimed at a *deity*);
  - **restore it** — *give the god back its own name and self,* the campaign's redemptive
    **chosen-transformation** counterweight to all the inflicted kinds ([overview §3B](../../nila/lore/campaign-overview.md));
  - **claim it / take its fire** — extend the stone-hand founder's bargain to its limit.
  `[OPEN]` whether this is a side climax or feeds the main Moku Kurunatuka finale.
- **The boon/curse, writ large.** `[loose]` The wild phoenix gives a **boon to those
  who take its tears** and a **curse to those who kill it** ([bestiary](../../suartleheim-eet/maalm/bestiary/egypt.md)).
  The god-scale version is a fair model for what the party earns by mercy vs. murder
  at its deathbed.
...
- `[OPEN]` **Do the Order's clergy know their god is a comet-beast?** (§3, §4) — and
  how much of the madness is hidden vs. denied.
- `[loose]` **Crusade-as-symptom:** how much of Kuru's reconquest is the mad god's
  hunger vs. ordinary empire (§4).
- `[loose]` 🔒 **Bad-pass link:** did the ~1,000-ya sabotage botch the phoenix's
  rebirth and accelerate its decline (§4)?
- `[OPEN]` **Puppet or person?** Whether the oldest warforged are still independent
...
*Sources / companions: [campaign overview](../../nila/lore/campaign-overview.md) (Names &
Ownership thesis; comet cycle; Kuru as dominant power),
[world-history-timeline.md](../../nila/lore/world-history-timeline.md) (comet cycle & passes),
[Taniyn & Lonka](../../lonka/lore/taniyn-and-lonka.md) / [Lonka — Jotunheim](../../lonka/lore/lonka-jotunheim.md)
(the one-life god that ended), [the Muspel empire](../../musleheim/lore/the-muspel-empire.md)
(colonization & reconquest), [the First Foundation](../../nila/lore/the-first-foundation.md)
(who founded Kuru), [house rules](../../nila/lore/house-rules-and-world-mechanics.md) (true
names), [Phoenix stat block](../../suartleheim-eet/maalm/bestiary/egypt.md).*
