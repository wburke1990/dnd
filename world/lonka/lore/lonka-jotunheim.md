...
> [floating-fleet](../../the-sea/lore/floating-fleet.md) (Lonka as Tyre), the
> [world-history timeline](../../nila/lore/world-history-timeline.md), and
> [Demons, the Hotspot, and the Deep Cities](../../nila/lore/demons-and-the-hotspot.md) (the
...
- This is the world of [Section I of the timeline](../../nila/lore/world-history-timeline.md) — the
...
- **Why here? Lonka was the hot spot's first seat.** `[settled]` Lonka sat over the
  **hot spot** — the place of **maximum heat, magic, and land-generation** in the first
  ...
  that became the Bleeding Star (§2) was fought on this very island** ([overview §5](../../nila/lore/campaign-overview.md):
  *dragons and demons follow the hot spot*). As the hot spot later **drifted southeast**
  — building Musleheim, and now surfacing the [Kurunatukas](../../musleheim/lore/the-muspel-empire.md) — that
...
[Amseh dynasty](../../suartleheim-eet/maalm/lore/amseh-dynasty.md)) **obliterated Lonka outright.** The round island and
...
*below* them (see [Kuru & the phoenix](../../kuru/lore/kuru-and-the-phoenix.md)).
...
- `[OPEN — demon first contact?]` Whether *this* — Kalikhat's underground survivors,
  ...
  [the Second Foundation](../../nila/lore/the-second-foundation.md) — so this is the first *pact*, not the
  demons' origin.)
...
(so, well after [Maalm's founding ~4,100 ya](../../suartleheim-eet/maalm/lore/maalm-founding.md)).
...
- **The dragonborn built Musleheim.** When the comet raised it (~4,000 ya), the
  ...
  So they were **founding members of the [First Foundation](../../nila/lore/the-first-foundation.md)** ("men
  *and* dragonborn") and of the **[Muspel empire](../../musleheim/lore/the-muspel-empire.md)** — and, settled on a
...
- **The zealots call the break a calling; it was a falling-out.** `[settled — Will]` They meant to
  ...
  [world-history timeline §VI](../../nila/lore/world-history-timeline.md)).
...
- **What they thought the killing was for.** `[Will 8/16]` Clearing the ground was part of the
  ...
  to **bring them back** — to cut the [covenant](../../nila/encounters/the-covenant-rite.md) again, at
...
- **They broke the rule: they used people instead of animals.** `[Will 8/16]` The
  [covenant](../../nila/encounters/the-covenant-rite.md) is cut with **someone else's** blood, never the
  pledger's own — but the someone else is **an animal in the stead of a person**, and that
  substitution is the dragons' rule ([lineages §4](../../nila/lore/lineages-and-afterlives.md), Genesis 22). The
...
- **Two departures, with different causes.** `[Will 8/16]` The dragons left **Lonka** around
  ...
  **Muspelheim** after the 5th pass, ~2,000 ya, for a different reason: the dragonborn there had
  ...
  ([lineages §4](../../nila/lore/lineages-and-afterlives.md)). They stay away a thousand years, then return for
  the 6th pass, and they are on **[Moku Kurunatuka](../../musleheim/lore/the-muspel-empire.md)** now, with the hot
...
zealots and the nomads** — his own falling-out with Sayid was the [Floating Fleet](../../the-sea/lore/floating-fleet.md)
...
- **The causeway as a *tunnel* — `[settled]`, this is how they came (§4):** the zealots
  **walked the Abyss tunnels from Muspelheim** under the sea (the Abyss *is* the
  tunnel-network; see [house rules](../../nila/lore/house-rules-and-world-mechanics.md)). `[settled —
...
- **The dragons no longer come — and the Zealots don't know why.** `[settled]` The
  ...
  Lonka** ([overview §5](../../nila/lore/campaign-overview.md)) toward the Kurunatukas. They left
  ...
  **[Tomb 4](../../suartleheim-eet/maalm/encounters/valley-of-the-kings.md)** — Amseh IV's empty thrones, *we called
  to you; you did not come; we did everything right and it meant nothing*
  ([the gods who do not answer](../../suartleheim-eet/maalm/lore/egyptian-afterlife-mythology.md)). Gods who abandon
  their faithful comes up elsewhere too, including Kuru's own god failing
  ([Kuru & the phoenix §4](../../kuru/lore/kuru-and-the-phoenix.md)). `[OPEN]` what they do about it — seek
...
- **The two trees — Askr and Embla.** At the highest point of the ring-wall stand **two
  ...
  [Pax's mother's people](../../nila/lore/lineages-and-afterlives.md) (§5–6) — two who lay down and became
...
- **The trees hold the story too.** The nameless carry the memory they are given
  ([lineages & afterlives](../../nila/lore/lineages-and-afterlives.md) §5, §11). Uprooted and carried
...
**god-stone**. The fleet reaches the [Moku finale](../../nila/lore/campaign-overview.md) as a third naval
...
- **Why they sail.** §5's open question — the dragons no longer come to Lonka and the
  ...
  spot**, and it has
  **drifted southeast off Lonka to Moku Kurunatuka** ([overview §5](../../nila/lore/campaign-overview.md)),
  ...
  there are usurpers on the dragons' seat, the same as the Maalm settlers were on Lonka
  (§4).

- **Only the zealots remember a pass.** The Bleeding Star was **Lonka's own Ragnarok,
  fought on their island** (§2), and the Dragon Turtle still in the bay means the
  sky-dragon won it (§5, Manichean note). So the comet already overhead
  ([overview, "the clock"](../../nila/lore/campaign-overview.md)) means something to them while the rest of
...
- **What the fleet does at Moku.** They come to take the island and get their gods back.
  ...
  - **The god-stone.** They mean to carry a shard of **Taniyn's heart-stone** (§5), or
    ...
    [Kuru re-forges its phoenix](../../kuru/lore/kuru-and-the-phoenix.md), and re-seat the dragons on
    Moku. It is what Preem does with the magma demon
    ([the Second Foundation](../../nila/lore/the-second-foundation.md)): take hold of a power instead of
...
- **What the archipelago sees.** The last time dragonborn came by sea in numbers they
  **killed everyone on the ground** — Jotunheim's colonists to the last, a slaughter the
  ...
  ([overview](../../nila/lore/campaign-overview.md)), and [Sam's halfling floating fleet](../../the-sea/lore/floating-fleet.md)
...
- **`[OPEN]` The dragonborn as the first break.** The zealot reconquest is already the
  **start of the Time of Troubles** and the end of the human–dragonborn partnership
  that built the [First Foundation](../../nila/lore/the-first-foundation.md) (§4). Taken further, the
...
- **`[draft]` Manichean Ragnarok — magma demon vs. sky dragon.** A working frame for the
  ...
  **flow out and build land** (Hawaii); a **fast** one **blows the world open**
  ...
  [common-ancestor rule](../../nila/lore/campaign-overview.md) — almost everyone else descends from
  ...
  forcing a slow eruption to happen all at once (see [the Second Foundation](../../nila/lore/the-second-foundation.md)).
...
*Companion docs: [Taniyn & Lonka](taniyn-and-lonka.md), [floating-fleet](../../the-sea/lore/floating-fleet.md)
(Lonka as Tyre), [the world-history timeline](../../nila/lore/world-history-timeline.md),
[the Second Foundation](../../nila/lore/the-second-foundation.md) (Ragnarok & demons).*
