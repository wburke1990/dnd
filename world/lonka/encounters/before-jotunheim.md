...
> [the rite at the Jotunheim trees](jotunheim-trees-rite.md): where the two trees are
> foreshadowed, where Pax learns each stage of the rite, and where he makes smaller
> versions of the choice he makes at the end.
>
> Companions: [lineages & afterlives](../../nila/lore/lineages-and-afterlives.md) §5–6 (his two
> lineages), [Pax — DM notes](../../../characters/pax-dm-notes.md),
> [Lonka / Jotunheim](../lore/lonka-jotunheim.md) §5,
> [the hell-tree](../../suartleheim-eet/brauron/encounters/the-hell-tree.md), [temple sites](../../nila/encounters/temple-sites.md).

---

## Pax's choice at death

Pax is the child of a Celestial and a forest-nameless woman, and at death he chooses
which claims him ([lineages & afterlives](../../nila/lore/lineages-and-afterlives.md) §6). The
two sides want opposite things done with a dead person.
...
Seven. Each teaches one stage of the rite, and each puts the same choice in front of
him. Order is loose; only **1** and **7** are fixed.

### 1. The newborn's name — the hell-tree `[written]`

Preem pays for the true name of a demon that has just come out of the fruit
([the hell-tree](../../suartleheim-eet/brauron/encounters/the-hell-tree.md)). A name taken in the first moments, before the
thing learns to guard it, and sold to a man who collects them.

- **Teaches:** that a true name gives its holder power over the named. Also the working
  consecration — a tree kept in power by the deaths around it, and a cult that runs
  the killing without going near the tree.
- **The choice, small:** take the name and get paid, or let the newborn go into the
  world unnamed and unowned.
- **Already on the itinerary.** Nothing needs building here except the window when a
  fruit opens.

### 2. Home — the forest of northwest Musleheim `[to build]`

His mother's country. The party goes among the forest-nameless and is there when one
of them lies down.

- **Teaches:** stage 1 and stage 5 of the rite — what the common stock is, and how the
...
- `[OPEN]` what the Verdant Fist has to do with this country, and whether the order
  came out of it or came to it.

### 3. The consecration at Kuru `[to build]`

Kuru is the crusader-colony ([Kuru & the phoenix](../../kuru/lore/kuru-and-the-phoenix.md)) and
has clergy. The party watches an altar made: the bones of someone who bled carried in
procession, the vigil overnight, the knocking at the shut door, the twelve anointings,
and the bones sealed into the stone.

- **Teaches:** stage 2, and the doctrine the whole rite runs on — no altar without a
  body under it.
- **The choice, small:** the bones belong to somebody's dead, and they are not going
  back into the ground. A relative is standing there watching them sealed in. The two
  faiths require opposite things be done with that body.
- `[for Doug]` Use the actual rite text. This is the period he studies, and he should
  be able to call the next step before it happens.

### 4. The violated shrine `[to build — small]`

A killing in a holy place. A priest comes, blesses water with salt, ashes and wine,
walks the ground sprinkling it, and refuses to consecrate anything, because the first
consecration stands and this is a reconciliation.
...
A degradation. The vestments come off in the reverse of the order they went on, and
the chrism is scraped off the man's fingers with a blade.

- **Teaches:** stage 4, done to a living person, so the scraping at Jotunheim is a
  thing they have watched.
- **The question:** whether he is still a priest afterwards. The period
  answered yes — the rite worked and cannot be unworked, whatever the man is. Which
  means the zealots' consecration of the two trees also worked, and the power in them
  is real however false the story is.

### 7. The creation, from a stranger's mouth `[to build — must come last]`

Before the party ever sees the ring-wall, someone tells them about the two trees: a
...
- **Better with two tellers.** A wandering dragonborn tells the same creation and
  ...
  island). Two tellings of the same creation, one with the trees in it and one without.
- Same as the mockingbird on the road to the hell-tree: the party hears about it before
  they arrive.
...
- **The warforged who became a grove** `[Will 8/15]` — the first statement of the rule,
  ...
  *"Trees live a long time, perhaps forever if you consecrate them with blood. Bring me
  ...
  paid for the rest of it. See [great-tree sites](../../nila/encounters/great-tree-sites.md).
...
- **Mímir's well** — a head in the water under the world-tree that names its price
  ...
  ([temple sites](../../nila/encounters/temple-sites.md)). The same trade the warforged ask for.
