---
summary: The priestesses of Artemis dress Cassia as the stag, using the steps of a Homeric sacrifice
status: ready
---

# The Dressing — Brauron
...
# PART ONE — BACKGROUND AND RULES
*Read in prep. Not needed at the table.*

---

> The temple scene that starts the hunt. The town is [Brauron](the-peach-town.md), the
...
to Apollo with the golden sword. Over the shadowy hills and windy peaks
she draws her golden bow, rejoicing in the chase, and sends out grievous
shafts.
```
