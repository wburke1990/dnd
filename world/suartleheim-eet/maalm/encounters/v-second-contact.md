...
> ([Session 7](../../../../sessions/session-07.md)) and [The Mill](the-mill.md) (V.'s
> writeup and stat block).
...
Both motives got **stronger** from what actually played:

- **The map.** No maps have **ever** changed hands — Ratatat failed to steal the
  party's atlas ([S1](../../../../sessions/session-01.md)) and the Second Hand's, so V.'s
...
**[Second Foundation](../../../nila/lore/the-second-foundation.md)**, whose ground this is.
...
not arrest** (see [the First Foundation](../../../nila/lore/the-first-foundation.md)).
...
**[Company](../../../nila/lore/the-company.md)** that is Preem's money. A coffeehouse is also
...
([Preem's demons](../../../../characters/preems-demons.md), [overview](../../../nila/lore/campaign-overview.md)).
...
- `[OPEN]` **Coffeehouse name and keeper** — every Nila tavern-keeper is a
  **Letap satyr** ([satyr-taverns](../../../nila/lore/satyr-taverns.md)); a coffee-house
...
- **DC 15 Perception / Investigation:** the rats move with her and watch the party —
...
- She named **Preem's controlling interest in the "Eet Suartleheim company"** (the
  [Company](../../../nila/lore/the-company.md)) and that **the coffee is not ethically sourced** —
...
- **The order, as she gave it.** Asked who they'd be working for, V. said little: her
  ...
  [Second Foundation](../../../nila/lore/the-second-foundation.md) war — she didn't name it), and
  ...
  *"do a few missions, gain my trust, and I will initiate you into my order — you will
  learn more then."* The order is the **[First Foundation](../../../nila/lore/the-first-foundation.md)**,
