...
> water-tunnels, is where **[V.](../../../nila/lore/the-first-foundation.md)** — the
> [First Foundation](../../../nila/lore/the-first-foundation.md)'s one agent in Maalm —
...
The trail runs **guard → Ratatat → V., and stops at V.** ([the rat man](../bestiary/the-rat-man.md),
[the First Foundation](../../../nila/lore/the-first-foundation.md)). The party has the guard
and the rat man. The mill is where the thread reaches V. — and where it ends,
...
dead-ground meeting spot instead of a face the rat man could sell.

**Why here.** "The mill" is the landmark Ratatat was told. The real meeting is
**below and around it**, in the **upper tunnels** — the hidden water-channels and
cisterns beneath the city ([the deep](../lore/maalm-the-elven-stronghold.md)) —
where an **older, water-driven mill** was cut into the rock long ago and left
half-abandoned at the edge of the forbidden deep. Nobody goes down there but the
cistern-keepers and the people who get lost and die. That suits V. exactly.

**The stakes are the introduction, not a kill.** V. is the face of the faction the
party may side with at the campaign's climax. First contact should leave them with
**a person, a place, and a seed** — not a corpse. Like the rat man, V. is built to
get away.
...
[First Foundation](../../../nila/lore/the-first-foundation.md), Preem's rivals — the older
...
of the way down (under pressure) and a small piece of misdirection: the party may
...
- **The traps are the pressure.** With no boss to fight, the tunnels carry the
  ...
  V. hears them coming and is halfway to the shaft when they arrive.
- **If Ratatat is present,** he is not the fight either — he screens and scatters. A
  party that fixates on the rat man lets V. walk.
- **The lead ends at V., on purpose.** Whatever happens, there is **no thread above
  V.** to pull — he is the cut-out's cut-out. What the party gains is a **person to
  find again, a place to watch, and a door into the deep.**
...
- **The First Foundation is now a face, not a rumor.** Even a glimpse of V. — a
  ...
  campaign ends on ([the First Foundation](../../../nila/lore/the-first-foundation.md),
  [overview](../../../nila/lore/campaign-overview.md)).
...
- [ ] **Wire the economy in** — bulk grain imported by boat; **export controls on
      organics** (fertilizer shortage; fits the guano/cistern laws) as the ambient
      law that also arms the [docks arrest](docks-departure.md); the artisanal mill
