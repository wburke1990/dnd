...
> **Maalm** so a *separate* session (loading David's large city maps) can pick up cold.
> It **summarizes** the canonical files listed at the bottom — if anything here and a
> source file disagree, the source file wins. Use the **spatial open-questions** (§9) to
> annotate the maps, then fold the answers back into
> [`maalm-the-elven-stronghold.md`](maalm-the-elven-stronghold.md).
>
> Legend: **[settled]** agreed · **[loose]** floated, not locked · 🔒 DM secret.

---

## 1. What Maalm is (the one-paragraph version)
...
- **No Roman sewers** on purpose: water-borne sewage would **waste the water and flush away
  nutrients.** Two deliberately separate flows:
  - **Clean water (a loop):** rain/flood → dams → underground channels → cisterns → gardens/
    city/terraces → **greywater** caught → terraces again.
  - **Waste (a resource):** **dry latrines → collection vaults → night-soil → composted with
...
- **Seabirds one bad season from collapse** (disease / overfished waters / climate swing /
  the dragons-and-demons drawn to the shifting hot spot) → existential quest.
- **Cautionary ghost underfoot:** the **Amseh** below recorded **crop yields falling to zero**
  before they collapsed; Maalm is **repeating the pattern on tireder soil.**

## 7. How Maalm ties to the wider world

- Its **exhausted soil** is the deliberate contrast to the **fertile Kurunatuka land rush**
  (the land-scarcity theme — [overview §5](../../../nila/lore/campaign-overview.md)).
...
## 8. Things still loose/open (non-spatial)
...
Locate on the maps and label:
- The **entrance gorge (Siq)** and any defensive choke points.
- The **seabird cliffs / guano colonies** relative to the city.
- The **wadi floors and terrace fields** (the productive land — low/central).
...
- 🔒 Any route by which the **deep (Ammit/Abyss)** could be reached from the cisterns.

## 10. Canonical source files (read these for full detail)
...
- [`lore/campaign-overview.md`](../../../nila/lore/campaign-overview.md) — land/food zero-sum theme, regions.
- [`lore/house-rules-and-world-mechanics.md`](../../../nila/lore/house-rules-and-world-mechanics.md) — the
  Abyss = tunnel-network.
- [`lore/the-second-foundation.md`](../../../nila/lore/the-second-foundation.md) — Preem / the council cabal.
- [`characters/party-roster.md`](../../../../characters/party-roster.md) — Sarric, the ecoterrorist PC.
