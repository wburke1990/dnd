...
ancient valley kings, ruled by an elven elite. Distilled from the 6/8–6/17/26
Discord brainstorm. Companion to the deep-history piece
[Maalm: The Founding Story](maalm-founding.md) and the political cabal in
...
- **Maalm is an elvish stronghold.** Like Kuru, it has a **varied population** —
  but where **men dominate Kuru, elves are the elite of Maalm.** **[settled]**
- The elite are the **old families with deep ties** — those who **settled after
...
- The gate is the **visible monument to ownership-by-name** — the families who
  ...
  [overview §2](../../../nila/lore/campaign-overview.md)).
...
- This is what canon already gestured at — the council is **not** simply the
  Second Foundation. **Preem's [Second Foundation](../../../nila/lore/the-second-foundation.md) is
...
- The **citadel is the four-pointed star fortress** of the founders' quarter (above). Within
  ...
  **Preem's tower.** A wizard residing in a place of power like this *should* raise eyebrows
  — and is meant to (see [The Second Foundation](../../../nila/lore/the-second-foundation.md)). **[settled]**
...
the **Abyss tunnel-network that honeycombs Nila** ([house rules](../../../nila/lore/house-rules-and-world-mechanics.md)).
- `[settled]` **The same Abyss — but cold here, and always was.** Maalm's deep is one reach of
  the great **[Abyss](../../../nila/lore/demons-and-the-hotspot.md)**, where the **demon deep cities** live — but
  ...
  **Kurunatukas**; [demons & the hotspot](../../../nila/lore/demons-and-the-hotspot.md)). So Maalm's deep was
...
(the spent ground the fertile [Kurunatukas](../../../nila/lore/campaign-overview.md) are measured against).
It survives by **wasting nothing** — a near-closed loop built on two scarce inputs,
**water** and **fertility**, each guarded by one of the city's **two iron laws** (given
to the players in the opening session). **[settled]**

### Water — the hidden cisterns
- Like the Nabataeans of Petra, Maalm lives off **water it captures, not water that
  falls when wanted.** A concealed network of **rock-cut cisterns, dams, and channels**
  harvests the rare **flash-flood rainfall** and stores it through the dry season;
  terraced fields are watered by **runoff led along carved conduits,** drop by drop.
- **The cisterns are hidden and their locations are state secrets** — the city's life
  *and* its ultimate defense: an enemy who cannot find the water cannot take or besiege
  Maalm, and the city can outlast any siege. Only a **trusted caste of cistern-keepers**
  holds the full map.
- **Iron law #1 (opening session):** **approach a hidden cistern and you will be
  killed** — no warning, no trial. **[settled]** *(To outsiders this reads as fanatical
  cruelty; it is actually existential security — a revealed cistern is a fatal
  weakness.)*

### Fertility — guano and the seabirds
- Maalm's **old soil is exhausted,** so its one renewable source of fertility is
  **guano** — the droppings of the **seabird colonies on the coastal cliffs** — which is
  extraordinarily rich in exactly what spent fields lack. Guano is **harvested, hoarded,
  and worked into the terraces;** it is, quite literally, what feeds the city.
- The seabirds are therefore **sacred and protected:** to kill one is to threaten the
  guano, and so the food, and so everyone.
- **Iron law #2 (opening session):** **never harm a seabird in Maalm.** **[settled]**
  Break it and the city turns on you.

### The closed cycle — waste nothing
- Because both water and nutrients are so scarce, Maalm runs a **near-total closed
  loop:** every drop of water is **captured and reused** (cistern → field → greywater →
  field again), and **every scrap of organic matter is returned to the soil** — **night
  soil, animal dung, crop residue, kitchen waste,** composted together with the precious
  guano. **Waste is close to taboo.**
- This is the [land-and-food zero-sum world](../../../nila/lore/campaign-overview.md) made into a way of
  life: a society **organized around scarcity and reuse** — the exact opposite of the
  **land-rush abundance** of the new [Kurunatuka](../../../kuru/lore/kuru-and-the-phoenix.md) soils, and a
...
- **Why the stop is unavoidable.** `[Will 7/29]` The archipelago's craft are **primitive and
  coast-hugging** — the standard [dwarf boat](../../../the-sea/lore/ships-and-sea-power.md) and its like fear the open
  water and creep headland to headland; only the **[dragonborn](../../../the-sea/lore/wandering-dragonborn.md)**
...
- The two iron laws are the **visible tip of a sacred ecological order,** likely wrapped
  ...
  relates to the [council](maalm-the-elven-stronghold.md) and the
  [Second Foundation](../../../nila/lore/the-second-foundation.md), is still to develop. **[loose]**
...
### Reveals for an ecology-minded party
...
- **Guano is wealth — and a *casus belli*.** Guano is so precious it invites **hoarding, a
  ...
  **Maalm's hunger for new land** — fresh seabird cliffs, or the fertile
  [Kurunatukas](../../../kuru/lore/kuru-and-the-phoenix.md). **[loose]**
- **The seabirds are one bad season from catastrophe.** A **seabird die-off** — disease,
  overfished waters, a comet-cycle climate swing, or the dragons/demons drawn to the
  [shifting hot spot](../../../nila/lore/campaign-overview.md) — would **starve Maalm.** A ready existential
  quest the eco-party would *care* about. **[loose]**
- **The cautionary ghost underfoot.** Maalm is built **atop the [Amseh](amseh-dynasty.md),
  whose own tombs record yields falling to zero before they collapsed** — a civilization
  that died when its ecology failed. Maalm is **repeating the pattern on tireder land,**
  and doesn't see it: a haunting parable for players who think in systems. **[settled]**
- **What an eco-PC can do.** Defend the seabird colonies; expose or break the water caste's
  monopoly; broker (or sabotage) the guano trade; or decide whether Maalm is a **model
  worth protecting or a regime worth toppling.** Sarric's *"Restoring our Clean Kingdom"*
  ([party roster](../../../../characters/party-roster.md)) points straight at all of it. **[loose]**
