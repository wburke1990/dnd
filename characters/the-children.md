...
**Ancestral heritage (paternal).** `[settled — table]` The al Qahtani line descends from the **Amseh faithful who survived the Dark Age underground** and came up when Maalm was raised over the tunnels. Ghassan held the proof — a **piece of godstone passed down ~5,000 years**, out of the empire, the one thing in the house he didn't buy (distinct from the small Anubis the rite needs). See [Muntadhir's tour](../encounters/the-dream-quest.md#the-tour--muntadhir-walks-them-through), and [Lucrecia](lucrecia.md), whose House Vettia shares the descent but denies it.
