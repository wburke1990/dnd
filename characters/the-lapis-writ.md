---
summary: Preem's crew that cleared the whole Valley, met at Aar with the peseshkef on Setha Renk's belt
status: reference
---

# The Lapis Writ — the crew that finished the Valley

> **NPC crew.** Five chartered name-hunters working the same contract as the
> party, for the same patron. They cleared every tomb in the
> [Valley of the Kings](../world/suartleheim-eet/maalm/encounters/valley-of-the-kings.md)
> without missing a name, and they say so. The party drank with them at the
...
**[Setha Renk](../world/suartleheim-eet/maalm/encounters/tavern-rival-crews.md#setha-renk--half-elf--lapis-writ-leader-blackacres-mirror)**
— half-elf, leader, Bard 3 (College of Lore). `↔` [Blackacre](blackacre.md)
...
All five are level 3. Full blocks, spell lists and the bath-house variants are in
[the godstone dagger §11](../world/suartleheim-eet/raand-copaa/encounters/the-godstone-dagger.md).

| Who | Class | HP | AC | Armour |
|---|---|---|---|---|
| Setha Renk | Bard 3 (Lore) | 24 | 14 | studded leather |
| Doruk Pell | Fighter 3 (Battle Master) | 31 | 18 | chain mail and shield |
| Bram Hale | Fighter 3 (Champion) | 28 | 17 | chain shirt and shield |
| Issa Quib | Cleric 3 (Grave) | 18 | 14 | leather |
| Calix Vire | Wizard 3 (Divination) | 17 | 15 | *Mage Armor* |

The toad has 7 hit points and AC 13.
...
([valley of the kings](../world/suartleheim-eet/maalm/encounters/valley-of-the-kings.md)).
🔒 That was the Writ. `[OPEN]` The session notes do not record the party drawing
any conclusion from it, and nobody at the table has connected it to Setha.

`[played]` **Session 13 — the evening at the Tally House, Aar.** The two crews and
the party in one room, with the Writ packed to sail in the morning. What happened,
PC by PC:

- **Sarric and Doruk.** Sarric went to him and they talked about killing people.
  Doruk told him not to feel bad about it. Sarric told him about Fester, the rat man
  he hates, and about taking the two fingers off. Doruk told him about an orc he
  cleaved shoulder to navel with his axe. Doruk bought the drinks. Asked about Setha's
...
- **Aniess and Setha.** Aniess rolled a natural 20 investigating her and read
  ...
  in it. They put the small Anubis and the peseshkef side by side and compared
  them, and **Aniess now knows the two are cut from the same stone**
  ([the godstone dagger](../world/suartleheim-eet/raand-copaa/encounters/the-godstone-dagger.md)).
  Setha asked whether Aniess is descended from Maalm's founder families or from
  the Amseh line. Aniess tried to tell her about the dream quest and did not
  impress her; Setha took the statue for tomb loot and they talked about tombs
  they had both been in. Aniess tried to put her in a drinking contest with Jasper
  and failed the persuasion check.
- **The two crews named each other.** Setha asked whether Aniess works for Preem
  and **Aniess said yes.** Aniess asked whether Setha was with the Brass Jackals
  and got *"Those amateurs?"*, then the boast that the Writ are the best crew
  there is and found the most names.
- **Sefi answered her back.** The Jackals' scout, across the room: *"Setha! Don't
  be such a jerk!"* Nobody else in either crew talks to Renk that way and Renk had
  nothing to say to it.
- **Pax.** He got Sarric to bring Setha over to meet him and Aniess.
- **Blackacre went upstairs.** He searched the guest house — empty rooms, locked
...
- **Setha knows Aniess works for Preem**, from Aniess's own mouth. Two of Preem's
...
- **The party do not know** what Setha did in tomb three, that Calix's toad is
  ...
  bottom.
- 🔒 **Preem knows whatever the toad saw at the Tally House.** It was in the room.
...
- `[OPEN]` **Whether Issa works out what preserved the body** Aniess carried. She
  is Grave Domain and can count Aniess's slots. Playing it means the Writ's cleric
  knows the party carry a piece of godstone.
- `[OPEN]` **What Calix knows about the murder** of Setha's mother. She was
  fourteen and it was not her house.
- `[OPEN]` **Whether the Writ are the "second party"** whose fuller name-sheet Mul
  waved at the party
  ([the game preserve](../world/suartleheim-eet/brauron/encounters/the-game-preserve.md)).
...
- [Preem](preem.md) — their patron, and the party's.
- [Preem's demons](preems-demons.md) — the toad, and the other two familiars.
...
- [Rival crew plots](../world/suartleheim-eet/maalm/encounters/rival-crew-plots.md) — what Preem pays which crew.
