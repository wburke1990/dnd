...
1. **Accept, and lead the attack.** He commands the fleet for the zealots, and they take
   Moku the way they took Lonka — the colonists killed, a second Lonka. The zealots'
   position is confirmed, and a wandering dragonborn leads the killing.
2. **Accept, and spare the island.** He takes command and stops the massacre, taking
   Moku without emptying it. He has to hold the command and refuse to use it that way.
   The rift closes the way he wanted.
3. **Refuse, and fight the fleet.** He turns on his own people to stop the killing.

We **don't settle any of it in advance** — we see where his character is when we get
there.

### The god-stone does nothing
...
- **Whether the people of Moku live.**
- **What the zealots learn.** The dragons will be at Moku when the fleet arrives, however
...
### Smaller versions of the choice

This choice shouldn't be the first time he faces it, so put smaller versions of it
