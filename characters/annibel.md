...
The campaign arc is Hannibal's arc: ruinous early victories, a famous crossing, a
long ravaging, a siege that never falls, a final Zama. Canon fills the ends; the
middle victories are drafts to name.
...
- `[settled — seed]` If she survived Ilka Mak: an **old, scarred half-orc drifter**,
  hunted from place to place, **selling sharp tactical advice for coin**, hiding her
  name — the last years of the real Hannibal (consultant to any court that would
  have him, cornered at the end). Unremarkable, the way half-orcs are everywhere in
  this world.
- `[settled]` **The reveal.** No one believes it is her until something forces the
  proof — a scar, a detail only she would know, the
  [Wanderer lament](../handouts/the-wanderer-lament.md) recited too deep in a cup,
...
- 🔒 `[draft — new]` **The Company** — Noku's merchant arm, which ruins and buys out
  the orc towns her people were driven into. This is written at the Haals mine (§4
  there); before it, her enmity was against Noku's armies alone.

## Running her at the table

- She is a **planner, not a brawler**: she gives intelligence, a plan, a cold read of
