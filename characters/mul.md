...
**The sending stone.** Mul holds the sending stone paired with the one the party carries into the [Valley of the Kings](../encounters/valley-of-the-kings.md). When the party relays the names they find in the tombs, Mul is the "associate" on the other end who receives them. What the wizard actually wants — royal names, divine names, or all of them — is something Mul has not clarified (see [Amseh dynasty](../lore/amseh-dynasty.md)).
