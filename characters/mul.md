...
**"We saw a serpent carved older than the tombs — gold-scaled, lapis-blue. What is it?"** *(the deep plot — the volcano-island, [Apep](../world/suartleheim-eet/maalm/encounters/valley-of-the-kings.md), the thing the whole campaign points at)*
...
- **DM note:** he never raises his voice and never gets angry — he just keeps walking the conversation back to the purse until they let it go. The wall has no door in it: if a PC won't drop it, he simply repeats that the questions aren't part of the deal and offers the next job. ("Some have [killed for wages like that]" is plainly true — the crews that didn't come home; see the [man who died in the tombs](../world/suartleheim-eet/maalm/encounters/valley-of-the-kings.md).)
...
**Disguise:** a Medium elf, worn at the wizard's tower
**Bound by:** [Preem](preem.md) — presumably by true name, like the rest of his demons
**Allegiance:** Preem's, by binding — not by choice

---

## DM Notes

- The party talks to "the elf" without knowing it is a Yochlol in continuous surface pain. The disguise compounds the suffering (maintaining a shape costs more — see house rules).
- Mul is deliberately evasive about which names the wizard wants. Whether that vagueness is the binding's limits, Mul's own self-interest, or Preem's instruction is up to you.
- Toxic Escape + Shape-Shift make Mul slippery if it ever comes to a fight; Dominate Person (1/day) is its dangerous trick.
- If freed or its binding lapses, a Chaotic Evil Yochlol with the party's sending stone and knowledge of the name-quest is a major loose thread.
...
*Habitat: Planar (Abyss). Source: MM'25, page 341. Referenced in FRAiF; FRHoF; RHW.*
