...
>
> DM-facing design notes live in the companion file,
> [`blackacre-dm-notes.md`](blackacre-dm-notes.md).
...
- **Still to confirm:** his birth name. Sam was checking. Nothing written needs it —
  Sayid's people ask after him by the sea-name, because that is the one strangers know.
...
answer is the climax of his arc. The design notes for it — the three choices, what his
answer decides, and how to give him practice first — are in
[`blackacre-dm-notes.md`](blackacre-dm-notes.md).
...
### Mukka
- A **Tortuga-esque pirate haven**. It survives because **all the kingdoms use
  it for their dirty work at sea** via **letters of marque**. **Separate from
...
- Dragonborn here are reimagined with a **Berber-flavored**, family- and
  tribe-centric culture. **[settled]**
...
- **Sayid** — former friend turned antagonist; co-opted part of the Floating
  ...
  is **hunting him ship by ship** by his sea-name, with money on him alive or dead ([the drifting wreck](../world/the-sea/encounters/the-drifting-wreck.md),
...
- **"Salahadin"** — reserved name, likely the **Zealot ruler** or someone
  significant; not yet placed. **[loose]**
