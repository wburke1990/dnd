...
| **BlueWater Inn** | 1fd7e3 | ✅ **winner — the Aar Tally House** | Imported 8/28, best of the four tavern candidates. Light prune: **34 pieces removed, 28 dead of 139 URLs**. Its floor came up **180° off and too small for the buildings**, both fixed with `adjust-ow-map`: the map is rotated 180° and scaled to **0.88**, taking its span from 71.4 × 31.1 to 62.9 × 27.4 — near Haagen's 63, the one size confirmed to read right on the default floor. No plate detected, default vBase 25, floor image live (Steam UGC). |
