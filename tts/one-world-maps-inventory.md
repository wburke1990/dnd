...
| **Druid's Circle** | f0152d | ✅ **good — keep, unused so far** | Imported and built 9/15. **A ring of standing stones around a druid camp: a fire, and a tree with a skull shape in it.** 86 pieces, 11 removed (4 dead of 46 URLs). No plate → default vBase 25. Steam-UGC floor, live, and the floor is a drawn battlemap of the stone ring rather than a ground texture. Looked at for the [Island of the Thinkers](../world/suartleheim-eet/brauron/encounters/the-last-thinker.md) and passed over for Grandfather Tree — **in staging, and worth a scene of its own.** New SBx `78baa4`. |
| **Grandfather Tree** | 9fcef4 | ✅ **winner — the Thinker's hilltop** | Imported and built 9/15, and chosen for [the Last Thinker](../world/suartleheim-eet/brauron/encounters/the-last-thinker.md). Only 4 objects in the bag, so it is a tree rather than a map — which is what that scene wants. Cleanest import so far: 1 dead of 6 URLs, nothing removed, plate-fit vBase 22.0. **Its own imgur floor image is a printed map illustration**, title card and "CROWN / OUTER RING / INNER RING" labels and all, so the SBx paint was swapped for **Small town's grass with the pond painted out**. That file is **local** (`Mods/Images/grass_no_pond.jpg`, `file://` URL) and shows on this machine only — upload it through TTS's **Cloud Manager** and swap the URL for the minted one to make it durable. New SBx `b739d8`. |
| **Low Hill** | 6e9f87 | 🔖 **reserved — a camp, not the Thinker's hill** | Imported and built 9/15. **A camp: trees, tents, and the gear that goes with them** — worth keeping for a camp scene, and not used for the [Island of the Thinkers](../world/suartleheim-eet/brauron/encounters/the-last-thinker.md). **30 of its 59 pieces were removed** (8 dead of 16 URLs), so what stands is half the donor map. Its Google-Sites floor image was **dead** and the map has no plate of its own, so the SBx paint was swapped to Small town's grass image (`steamusercontent-a.akamaihd.net/ugc/11935844772624656728/4538301478A9CAAB48F9148595A7F0FBAFCED99A/`, live, 800 KB), which has a pond in it. 47 GUID collisions remapped on import. New SBx `401161`. |
