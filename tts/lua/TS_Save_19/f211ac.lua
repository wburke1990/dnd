-- DNDMiniInjector
-- Credit to HP Bar Writer: Kijan
-- Original Code Writer: ColColonCleaner
-- Code Last Modified: NightStorm
--[[LUAStart
...
function rebuildUI()
    ...
    for i, figure in ipairs(initFigures) do
        ...
        if (perc <= 0) then extraText = ' (Dead)'
        elseif (perc <= 0.05) then extraText = ' (Deaths Door)'
        elseif (perc <= 0.25) then extraText = ' (Badly Wounded)'
        elseif (perc <= 0.5) then extraText = ' (Bloodied)'
        elseif (perc <= 0.75) then extraText = ' (Bruised)'
        elseif (perc < 1.0) then extraText = ' (Healthy)'
        else extraText = ' (Untouched)'
        end
