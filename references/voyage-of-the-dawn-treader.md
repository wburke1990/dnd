...
* Prince Caspian*. We can draw on some of the islands the* Dawn Treader *visits.
Will is particularly interested in **the pool that turns everything to gold**
(Deathwater Island) and **the dragon's treasure that transforms the wearer
permanently** (Eustace).*

**Already drawing on it:** the Eustace transformation backs the planned
greed-into-a-dragon arc and the [dragon's-hoard warning handout](../handouts/dragon-hoard-warning.md).
Other threads that rhyme with the campaign: the **Lone Islands slave trade**
(Caspian frees all slaves) ↔ the binding/slavery theme; and Aslan's parting line
about having **"another name" in our world** ↔ the names-and-ownership thesis.

---

## Plot summary (source material)
