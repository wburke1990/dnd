---
summary: Xenophon, "Cynegeticus," trans. Dakyns — hunting as a gift of Apollo and Artemis
status: reference
---

# Xenophon — On Hunting

> **Handout — manual.** Xenophon, *Cynegeticus* (*On Hunting*, Dakyns titles it *The
> Sportsman*), translated by **H. G. Dakyns** (1897) — public domain. Three passages:
> the opening, which gives hunting to Apollo and Artemis and has them hand it down to
> Cheiron; the prayer a hunter makes before he slips the first hound, promising the
...
> (https://www.gutenberg.org/ebooks/1180).

---

## The gift — Book I, opening
...
Dakyns' footnote 1 gives a second reading of the first sentence: *"This thing is the
invention of no mortal man, but of Apollo and Artemis, to whom belong hunting and
dogs."*

## The share — Book VI

The hunter says this in the covert, before he lets the first hound loose.

```
When that is done, and while
...
## The young left alone — Book V

```
Every true sportsman, however, will leave these quite
young creatures to roam freely. (27) "They are for the goddess."
```

---

*Real-world attribution: Xenophon,* Cynegeticus*, tr. H. G. Dakyns (1897).*
