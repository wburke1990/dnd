...
> Upas Tree"), 1828. A single poison-tree stands alone in a desert, its venom
> killing everything near it; a ruler sends a slave to fetch the poison, the
> slave dies bringing it back, and the ruler tips his arrows with it and kills
> his neighbors. Two English translations below. The first ("The Upas Tree")
> translator is unidentified — `[to confirm]`. The second is by Yevgeny Bonver.
> Kept verbatim (a couple of rough lines in the Bonver left as-is).

## The Upas Tree — translator unidentified `[to confirm]`
